...
const ServiceBlog = () => {
    return (
        <>
            <section className="sc-service-section-area inner_service gray-bg sc-pt-130 sc-md-pt-70 sc-pb-140 sc-md-pb-50">
                <div className="container">
                    <div className="row">
                        <div className="col-md-6 offset-md-3">
                            <div className="sc-heading-area text-center sc-mb-55">
                                <h2 className="heading-title">Digitally Transform Your Workplace</h2>
                            </div>
                        </div>
                    </div>
                    <div className="row">
                            ...
                            <div className="col-lg-3 col-md-6 col-sm-6">
                                <div className="sc-service-content-box text-center sc-md-mb-30">
                                    <div className="service-icon">
                                        <svg className="sc-mb-25" width="49" height="49" viewBox="0 0 49 49" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                    ...
                                    <h4 className="sc-mb-0"><Link to="#">Engage Customers</Link></h4>
                                </div>
                            </div>
                        </Fade>
                        <Fade bottom delay={200}>
                            <div className="col-lg-3 col-md-6 col-sm-6">
                                <div className="sc-service-content-box text-center sc-md-mb-30">
                                    <div className="service-icon">
                                        <svg className="sc-mb-25" width="70" height="48" viewBox="0 0 70 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                fillRule="evenodd"
                                                clipRule="evenodd"
                                    ...
                                    <h4 className="sc-mb-0"><Link to="#">Team Management</Link></h4>
                                </div>
                            </div>
                        </Fade>
                        <Fade bottom delay={300}>
                            <div className="col-lg-3 col-md-6 col-sm-6">
                                <div className="sc-service-content-box text-center sc-md-mb-30">
                                    <div className="service-icon">
                                        <svg className="sc-mb-25" width="43" height="49" viewBox="0 0 43 49" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                    ...
                                    <h4 className="sc-mb-0"><Link to="#">Apps Integration</Link></h4>
                                </div>
                            </div>
                        </Fade>
                        <Fade bottom delay={400}>
                            <div className="col-lg-3 col-md-6 col-sm-6">
                                <div className="sc-service-content-box text-center sc-md-mb-30">
                                    <div className="service-icon">
                                        <svg className="sc-mb-25" width="63" height="49" viewBox="0 0 63 49" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                    ...
                                    <h4 className="sc-mb-0"><Link to="#">Always In Sync</Link></h4>
                                </div>
                            </div>
                        </Fade>
                    </div>
